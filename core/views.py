...
def profile(request):
    if request.user.role == student:
        ...
        {"form" : form, "user" : our_student, "role" : "student", "group" : StudyGroup.objects.filter(student=our_student).first().group_title})
        ...
        return render(request, "profile.html", {"form" : form, "user" : our_teacher, "user" : request.user, "role" : "teacher", "completed_lessons" : complete_lessons, "loaded_lessons" : loaded_lessons})
